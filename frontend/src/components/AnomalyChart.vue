<template>
  <div class="panel"><h4>📈 异常分数 (3-sigma + IQR)<span v-if="store.readOnly" class="ro-badge">只读</span></h4><div ref="chart" class="chart" :class="{big:store.readOnly}"></div></div>
</template>
...
<style scoped>.panel{background:#1e293b;border-radius:8px;padding:12px;border:1px solid #334155}.panel h4{color:#38bdf8;font-size:13px;margin-bottom:4px}.chart{width:100%;height:220px}.chart.big{height:360px}</style>